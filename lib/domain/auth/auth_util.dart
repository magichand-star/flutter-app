...
Future<UsersRecord?>? initCurrentUserDocument() async {
  if (FirebaseAuth.instance.currentUser != null) {
    currentUser = MonarchiumFirebaseUser(FirebaseAuth.instance.currentUser);
    currentUserDocument = await UsersRecord.getDocumentOnce(
        UsersRecord.collection.doc(FirebaseAuth.instance.currentUser!.uid));
  }
  // print(currentUserDocument?.emblems);
